...
public class DriverSchedulingMain extends JFrame {
    ...
    public DriverSchedulingMain(Counter ds, Staff s) {
    ...
    public void design(Counter ds, Staff s) {
        ...
        jpRight = new DriverSchedulingPanel(ds, s);
    ...
    public static ImageIcon createImageIcon(String path, int w, int h) {
        ImageIcon img = null;
        ImageIcon icon = null;
        java.net.URL imgURL = DriverSchedulingMain.class.getResource(path);

        try {
            img = new ImageIcon(DriverSchedulingMain.class.getResource(path));
