...
import static BUSUI.DriverSchedulingMain.createImageIcon;
...
public class RefundCancelMain extends JFrame {
    ...
    public RefundCancelMain(Counter ds, Staff s) {
    ...
    public void design(Counter ds, Staff s) {
        ...
        jpRight = new RefundCancelPanel(ds, s);
    ...
    public static ImageIcon createImageIcon(String path, int w, int h) {
        ImageIcon img = null;
        ImageIcon icon = null;
        java.net.URL imgURL = RefundCancelMain.class.getResource(path);

        try {
            img = new ImageIcon(RefundCancelMain.class.getResource(path));
